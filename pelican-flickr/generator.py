...
class FlickrGenerator(generators.Generator):
    ...
    def generate_output(self, writer):
        ...
        '''
        for photoset in pelicanflickr.FLICKR_CACHE.sets:
            ...
            for i, photo in enumerate(photoset.photos):
                ...
                next = \
                    i+1 < len(photoset.photos) \
                    and photoset.photos[i+1] \
                    or None
    ...
    def generate_photoset(self, writer, photoset):
        ...
        writer.write_file(photoset.generated_path,
                          template, self.context,
                          rurls, override_output=True)
    ...
    def generate_photo(self, writer, photo, next=None, previous=None):
        ...
        rurls = self.settings['RELATIVE_URLS']
        writer.write_file(photo.generated_path,
                          template, self.context, rurls,
